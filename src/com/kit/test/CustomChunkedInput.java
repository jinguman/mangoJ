 ...
 * </pre>
 */
public class CustomChunkedInput implements ChunkedInput<HttpContent> {
     ...
     */
    public CustomChunkedInput(ChunkedInput<ByteBuf> input) {
        this.input = input;
     ...
     *            training headers.
     */
    public CustomChunkedInput(ChunkedInput<ByteBuf> input, LastHttpContent lastHttpContent) {
        this.input = input;
